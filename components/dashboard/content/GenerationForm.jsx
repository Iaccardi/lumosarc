...
export default function GenerationForm({
  ...
  /* ───────────────── AI mocks (swap for real calls) */
  const aiObjective = async () => {
    setBusy(true)
    await new Promise(r=>setTimeout(r,600))
    setObjective('I want to promote my new fitness product and educate my audience about its benefits.')
    setBusy(false)
  }
        ...
        {step===1 && (
          <>
            ...
            <button 
              ...
              onClick={aiObjective}
              disabled={busy}
              className="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1 mt-2 disabled:opacity-50">
